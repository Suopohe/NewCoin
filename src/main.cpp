...
uint256 hashGenesisBlock("0x6f885c72b3978fec0700c87fc56f2aaaa4aeef0c7c22761f9781f24f8c6faa91");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9c98983a37f880b0ee6b7c3d41590fd51f993f78a90b813cda0ec9c0d626f1dd");
    }
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        block.nVersion = 1;
        block.nTime    = 1515650004;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087069199;

        if (fTestNet)
        {
            block.nTime    = 1515650004;
            block.nNonce   = 386880615;
        }
